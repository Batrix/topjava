...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealWithExceed> getListWithExceeded(int caloriesPerDay) {
        return getFilteredWithExceeded(MEAL_LIST, LocalTime.MIN, LocalTime.MAX, caloriesPerDay);
    }
}